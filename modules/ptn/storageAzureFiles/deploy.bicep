metadata name = 'AVD - Storage Azure Files'
metadata description = 'This module deploys storage (Azure Files) for FSLogix or MSIX.'
...
module storageAndFile 'br/public:avm/res/storage/storage-account:0.8.2' = {
...
module addShareToDomainScript './modules/azureFilesDomainJoin.bicep' = {
    scope: resourceGroup('${workloadSubsId}', '${serviceObjectsRgName}')
